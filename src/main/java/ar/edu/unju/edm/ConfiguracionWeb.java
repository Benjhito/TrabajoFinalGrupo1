...
public class ConfiguracionWeb extends WebSecurityConfigurerAdapter {
	...
	String[] resources = new String[] { "/include/**",  "/css/**", "/icons/**", "/img/**", 
			"/js/**", "/layer/**", "/webjars/**"};
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.authorizeRequests()
				...
				.antMatchers("/formMedico", "/formPaciente", "/formServicio", "/formEspecialidad", "/formPaciente", "/listaPacientes", "/listaPaciente_servicio").hasAuthority("ADMIN")
